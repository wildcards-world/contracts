...
contract("WildcardSteward owed", accounts => {
  ...
  beforeEach(async () => {
    ...
    //await erc721.mintWithTokenURI(steward.address, testToken0.id, testTokenURI, { from: accounts[0] })
    await erc721.mintWithTokenURI(
      steward.address,
      testToken1.id,
      testTokenURI,
      { from: accounts[0] }
...
//     await mintManager.initialize(steward.address, erc20.address, {
//       from: accounts[0]
//     });
//     await erc721.setup(
//       steward.address,
