...
const debug = debug_1.default("codec:decode:special");
    ...
    switch (pointer.special) {
        case "msg":
            return {
                ...
                value: {
                    ...
                    sender: yield* value_1.default(senderType(info.currentContext.compiler), { location: "special", special: "sender" }, info),
                    value: yield* value_1.default({
                        typeClass: "uint",
                        bits: 256
        ...
        case "tx":
            return {
                ...
                kind: "value",
                value: {
                    origin: yield* value_1.default(externalAddressType(info.currentContext.compiler), { location: "special", special: "origin" }, info),
                    gasprice: yield* value_1.default({
                        typeClass: "uint",
                        bits: 256
        ...
        case "block":
            let block = {
                coinbase: yield* value_1.default(externalAddressType(info.currentContext.compiler), { location: "special", special: "coinbase" }, info)
            };
            ...
            for (let variable of variables) {
                block[variable] = yield* value_1.default({
                    typeClass: "uint",
                    bits: 256
