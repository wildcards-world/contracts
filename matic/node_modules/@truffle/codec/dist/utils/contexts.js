...
const debug = debug_1.default("codec:utils:contexts");
...
(function (ContextUtils) {
    ...
    ContextUtils.findDecoderContext = findDecoderContext;
    ...
    ContextUtils.findDebuggerContext = findDebuggerContext;
    ...
    ContextUtils.matchContext = matchContext;
    ...
    ContextUtils.normalizeContexts = normalizeContexts;
    ...
    ContextUtils.contextToType = contextToType;
})(ContextUtils = exports.ContextUtils || (exports.ContextUtils = {}));
