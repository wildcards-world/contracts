    ...
    switch (dataType.typeClass) {
        ...
        case "function":
            switch (dataType.visibility) {
                case "external":
                    if (!checkPaddingRight(bytes, Evm.Utils.ADDRESS_SIZE + Evm.Utils.SELECTOR_SIZE)) {
                        let error = {
...
function decodeInternalFunction(dataType, deployedPcBytes, constructorPcBytes, info) {
    ...
    let context = Contexts.Utils.contextToType(info.currentContext);
