...
const debug = debug_1.default("codec:interface:decoders:contract");
const CodecUtils = __importStar(require("../../utils"));
const utils_1 = require("../../utils");
const contexts_1 = require("../../types/contexts");
...
const decoding_2 = require("../../core/decoding");
const storage_2 = require("../../types/storage");
const storage_3 = require("../../utils/storage");
...
exports.default = ContractDecoder;
class ContractInstanceDecoder {
    ...
    decodeVariable(variable, block) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decoder = decoding_2.decodeVariable(variable.definition, variable.pointer, info);
    ...
    watchMappingKey(variable, ...indices) {
        ...
        while (slot !== undefined &&
            this.mappingKeys.every(existingSlot => !storage_3.equalSlots(existingSlot, slot)
    ...
    unwatchMappingKey(variable, ...indices) {
        ...
        this.mappingKeys = this.mappingKeys.filter(existingSlot => {
            while (existingSlot !== undefined) {
                if (storage_3.equalSlots(existingSlot, slot)) {
    ...
    constructSlot(variable, ...indices) {
        ...
        switch (utils_1.Definition.typeClass(parentDefinition)) {
            case "array":
                ...
                if (!storage_3.isWordsLength(size)) {
                    return [undefined, undefined];
                }
                slot = {
                    path: parentSlot,
