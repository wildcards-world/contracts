...
exports.schemaAbiToAbi = schemaAbiToAbi;
...
exports.abiHasFallback = abiHasFallback;
...
function getFallbackEntry(abi) {
    ...
    return (abi.find(abiEntry => abiEntry.type === "fallback") ||
        exports.DEFAULT_FALLBACK_ABI);
}
exports.getFallbackEntry = getFallbackEntry;
...
exports.fallbackAbiForPayability = fallbackAbiForPayability;
