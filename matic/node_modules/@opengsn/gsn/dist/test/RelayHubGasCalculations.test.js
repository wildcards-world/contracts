...
contract('RelayHub gas calculations', function ([_, relayOwner, relayWorker, relayManager, senderAddress, other]) {
    ...
    describe('#relayCall()', function () {
        it('should set correct gas limits and pass correct \'maxPossibleGas\' to the \'preRelayedCall\'', async function () {
        ...
        it('should set correct gas limits and pass correct \'gasUsedWithoutPost\' to the \'postRelayCall\'', async () => {
            ...
            assert.closeTo(gasUseWithoutPost, usedGas - estimatePostGas, 100, `postOverhead: increase by ${usedGas - estimatePostGas - gasUseWithoutPost}\
        \n\tpostOverhead: ${Environments_1.defaultEnvironment.relayHubConfiguration.postOverhead + usedGas - estimatePostGas - gasUseWithoutPost},\n`);
        });
    ...
    function logOverhead(weiActualCharge, workerGasUsed) {
        ...
        if (gasDiff !== '0') {
            ...
            Environments_1.defaultEnvironment.relayHubConfiguration.gasOverhead += parseInt(gasDiff);
            console.log(`=== fixed:\n\tgasOverhead: ${Environments_1.defaultEnvironment.relayHubConfiguration.gasOverhead},\n`);
        }
    }
