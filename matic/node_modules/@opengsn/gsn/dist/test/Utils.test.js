...
const CommandsLogic_1 = __importDefault(require("../src/cli/CommandsLogic"));
...
contract('Utils', function (accounts) {
    describe('#getEip712Signature()', function () {
        ...
        describe('#callForwarderVerifyAndCall', () => {
            it('should return revert result', async function () {
                ...
                const expectedReturnValue = TestUtils_1.encodeRevertReason('always fail');
    ...
    describe('#resolveGSNDeploymentFromPaymaster()', function () {
        it('should resolve the deployment from paymaster', async function () {
            ...
            const defaultConfiguration = GSNConfigurator_1.configureGSN({});
            const commandsLogic = new CommandsLogic_1.default(host, defaultConfiguration);
            ...
            const resolvedPartialConfig = await GSNConfigurator_1.resolveConfigurationGSN(web3.currentProvider, partialConfig);
        ...
        it('should throw if no paymaster at address', async function () {
            await expect(GSNConfigurator_1.resolveConfigurationGSN(web3.currentProvider, {})).to.be.eventually.rejectedWith('Cannot resolve GSN deployment without paymaster address');
        });
    });
});
