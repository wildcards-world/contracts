...
export declare function getNetworkUrl(network?: string): string;
...
export declare function saveDeployment(deploymentResult: DeploymentResult, workdir: string): void;
export declare function showDeployment(deploymentResult: DeploymentResult, title: string | undefined, paymasterTitle?: string | undefined): void;
export declare function loadDeployment(workdir: string): DeploymentResult;
