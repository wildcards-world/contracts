...
function getNetworkUrl(network = '') {
    ...
    return (_b = exports.networks.get(network)) !== null && _b !== void 0 ? _b : match[0];
}
    ...
    options.forEach(option => {
        switch (option) {
            ...
            case 'm':
                ...
                break;
            case 'g':
                commander_1.default.option('-g, --gasPrice <number>', 'gas price to give to the transaction. Defaults to 1 gwei.', '1000000000');
                break;
        }
    });
