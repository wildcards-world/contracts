...
class GsnTestEnvironmentClass {
    ...
    _runServer(host, deploymentResult, from, relayUrl, port, debug = true) {
         ...
         */
        const interactor = new ContractInteractor_1.default(new web3_1.default.providers.HttpProvider(host), GSNConfigurator_1.configureGSN({ relayHubAddress: deploymentResult.relayHubAddress }));
