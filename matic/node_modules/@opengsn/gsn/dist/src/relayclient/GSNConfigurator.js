 ...
 * @param partialConfig
 */
async function resolveConfigurationGSN(provider, partialConfig) {
    ...
    const contractInteractor = new ContractInteractor_1.default(provider, defaultGsnConfig);
    ...
    return Object.assign({}, defaultGsnConfig, partialConfig, resolvedConfig);
}
exports.resolveConfigurationGSN = resolveConfigurationGSN;
